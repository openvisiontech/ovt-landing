...
* **Project Uli Kaya:** Successfully deployed uliSDK on a 3-wheel autonomous development platform. Demonstrated real-time telemetry exportation and agentic task execution via a unified interface, bridging bare-metal C++ and Agentic reasoning.  
* **Open Vision Tech Ecosystem:** Developed a high-tech consultation and landing page infrastructure (ovt-landing) utilizing modern tech stacks (React/Tailwind) to manage automated client workflows and SDK distribution.
